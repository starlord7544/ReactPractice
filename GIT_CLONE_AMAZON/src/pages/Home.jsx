...
const Home = () => {
  ...
  return (
    <div className="home-container flex-1 flex flex-col relative" onClick={() => setTheme("dark")}>
      <div className="home gap-4 p-4 w-full max-w-[1500px] m-auto flex flex-col relative">
      <div className="home-cards-continer w-full flex flex-wrap justify-between gap-4 mx-auto">
